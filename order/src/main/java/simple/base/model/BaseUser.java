...
@Operation(parameters = {
		@OperationParameter(code = "password", title = "新密码", value = "111111") }, code = "reset", iconStyle = "fa fa-expeditedssl", multi = true, name = "重置密码", handler = BaseUserResetOperationHandler.class)
...
@GenericGenerator(name = "idStrategy", strategy = "native", parameters = {
		@Parameter(name = "sequence", value = "SEQ_BASE_USER") })
@FieldCombination(fieldNames = { "id", "password", "password1" }, fieldRules = { "2,3", "1" }, message = "密码和确认密码不能为空！")
public class BaseUser implements Serializable {
	...
	@JoinTable(name = "BASE_ROLE_USER", joinColumns = {
			@JoinColumn(name = "USER_ID", nullable = false, updatable = false) }, inverseJoinColumns = {
					@JoinColumn(name = "ROLE_ID", nullable = false, updatable = false) })
	@OrderBy("id ASC")
	@RepresentationField(view = RepresentationFieldType.TAB, title = "所属角色")
	@TabView(TabViewType.SELECT_LIST)
	private Set<BaseRole> roles;

	@Column(name = "SID", length = DataLength.LONG_TEXT_LENGTH)
	private String sid;

	@ManyToOne
	@JoinColumn(name = "TRADER_ID")
	@RepresentationField(sort = 170, title = "交易者", view = RepresentationFieldType.REFERENCE, isSearchField = true)
	@Reference(id = "id", label = "name", type = ReferenceType.SINGLE_QUERY)
	@AssociateTableColumn(titles = "交易者", columns = "name", sorts = "150")
